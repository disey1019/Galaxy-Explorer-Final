...
export const LEVELS: Level[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'c-4',
        text: '合歡山馬雅平台（合歡山主峰步道第一觀景平台）之所以著名，是因為它是臺灣哪項認證的地點？',
        source: '特展｜E區：銀河不可思議之旅',
        options: [
          { id: 'A', text: '國家級地質觀測站' },
          { id: 'B', text: '世界自然遺產' },
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'gs-2',
        text: '星系常因彼此間的重力作用而群聚成「星系團」。其中成員較少、體積較小的星系團也常被稱為「星系群」。下列哪一個星系團離我們最近？',
        source: '展示場三樓:星系的群聚',
        options: [
          { id: 'A', text: '室女座星系團' },
          { id: 'B', text: '后髮座星系團' },
